...
bool Cluster::isInside(cv::Point p)
{
...
// and 'p2q2' intersect.
bool Cluster::doIntersect(cv::Point p1, cv::Point q1, cv::Point p2, cv::Point q2)
{
...
bool Cluster::onSegment(cv::Point p, cv::Point q, cv::Point r)
{
...
// 1 --> Clockwise
// 2 --> Counterclockwise
int Cluster::orientation(cv::Point p, cv::Point q, cv::Point r)
{
